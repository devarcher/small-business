...
class GoogleMap extends Component {
  ...
  render() {
    ...
    console.log(this.props.biz.name)
    ...
    return (
      ...
      <div style={{ height: "45vh", width: "100%" }}>
        ...
        >
          <this.AnyReactComponent style={{ cursor: 'pointer' }} lat={this.state.geocode.lat} lng={this.state.geocode.lng} text={`${this.props.biz.name}`} />
        </GoogleMapReact>
      </div>
    );
  }
